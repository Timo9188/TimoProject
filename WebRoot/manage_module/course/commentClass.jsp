...
<script type="text/javascript">
	function goback(){
		location.href='endClass.php';
	}
	
	function endClassEnd(){
		var _id = document.getElementById('hiddenID').value;
		var _cn = document.getElementById('className').value;
		var _tn = document.getElementById('teacherName').value;
		var _comments = document.getElementById('mark').value;
		if(confirm("确定结课?")) {
			location.href='endClassEnd.php?ids='+_id+'&className='+_cn+'&teacherName='+_tn+'&comments='+_comments;
		}else{
			return;
		}
	}
...
<table id="mytable" width="100%" border="1" align="center" style="text-align:left">
  ...
  <tr height="40px">
		<td>结课评语</td>
		 <td colspan="3" align="left" valign='top'><textarea name="mark" style="resize: none; height: 100px; width: 100%;" id="mark" ></textarea></td>
  </tr>
</table>
<input type="hidden" name="hiddenID" id="hiddenID" value=""></input>
<div align="right">
  <input id="save" name="save" type="button" value="结课" style="font-size:16px" onclick="endClassEnd();"/>
