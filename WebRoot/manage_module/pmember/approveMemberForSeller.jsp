...
<script type="text/javascript">
	...
	function open_card1(str){
		location.href='improveNonmemberForSeller.php?'+str;	
	}
</script>

<form action="approveMemberForSeller.php" method="post" >
...
<div  style='overflow-x:auto; width: 100%; height:300px'><table border='0' width='800px'  style='text-align:center'><thead bgcolor='#BBBBBB'><th id='th_1'></th><th id='th_1'>非会员ID</th><th id='th_2'>姓名</th><th id='th_3'>地址</th><th id='th_4'>电话</th><th id='th_5'>性别</th></thead>显示第 <B>0</B>-<B>0</B> 条记录，共 0 条记录</table></div>